...
print('----matrix_u_generate initiated----')
ExcelFile = xlrd.open_workbook(r'..\total_b.xls')
sheet = ExcelFile.sheet_by_index(0)
nrows = sheet.nrows
ncols = sheet.ncols
ExcelFile2 = xlrd.open_workbook(r'..\data2\up\ttu_b.xls')
sheet2 = ExcelFile2.sheet_by_index(0)
nrows2 = sheet2.nrows
ncols2 = sheet2.ncols

workbook = xlsxwriter.Workbook(r'..\total_g_u.xls')
worksheet = workbook.add_worksheet(u'sheet1')
worksheet.write('A1','Source')
worksheet.write('B1','Related_Rank_u')
worksheet.write('C1','Related_Target_u')
...
workbook.close()
print('----matrix_u_generate complete----')
